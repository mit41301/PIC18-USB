...
#define HARDWARE_PROFILE_LOW_PIN_COUNT_USB_DEVELOPMENT_KIT_H
    ...
    /** LED ************************************************************/
    #define mInitAllLEDs()      LATC &= 0xFC; TRISC &= 0xFC; // LATC &= 0xF0; TRISC &= 0xF0;
	...
	// External Buttons
	#define BTN_C PORTCbits.RC3
	#define BTN_R PORTCbits.RC6
	#define BTN_L PORTCbits.RC4

	#define mInitAllButtons() {\
		ANSELbits.ANS7 = 0;\
		ANSELHbits.ANS8 = 0;\
		TRISC |= 0b01011000;\
	}

	#define FLP_L() BTN_L ? 0 : 0x1d
	#define FLP_R() BTN_R ? 0 : 0x38
	#define PLANJ() BTN_C ? 0 : 0x2c
