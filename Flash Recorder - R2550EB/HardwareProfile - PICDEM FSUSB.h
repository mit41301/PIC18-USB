...
#define HARDWARE_PROFILE_PICDEM_FSUSB_H
    ...
    #define tris_usb_bus_sense  TRISBbits.TRISB3    // Input
    ...
    /** LED ************************************************************/
    #define mInitAllLEDs()      LATB |= 0x30; TRISB &= 0xCF // LATD &= 0xF0; TRISD &= 0xF0;
    
    #define mLED_1              LATBbits.LATB4 // LATDbits.LATD0
    #define mLED_2              LATBbits.LATB5 // LATDbits.LATD1
    ...
    #define mLED_1_On()         mLED_1 = 0; // mLED_1 = 1;
    #define mLED_2_On()         mLED_2 = 0; // mLED_2 = 1;
    // #define mLED_3_On()         mLED_3 = 1;
    // #define mLED_4_On()         mLED_4 = 1;
    
    #define mLED_1_Off()        mLED_1 = 1; // mLED_1 = 0;
    #define mLED_2_Off()        mLED_2 = 1; // mLED_2 = 0;
    ...
    #define sw2                 PORTEbits.RE3 // PORTBbits.RB4
    #define sw3                 PORTEbits.RE3 // PORTBbits.RB5
